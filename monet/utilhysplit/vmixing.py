...
CTYPE: source code
ABSTRACT: classes for the vmixing HYSPLIT utility.
"""


class VmixingRun:
    """ class for creating CONTROL file and command for running vmixing"""
    ...
    def __init__(
        ...
        self.pid = cname.replace("CONTROL.", "")
...
class VmixingData:
    """
        Reads output from vmixing utility
        add_data
